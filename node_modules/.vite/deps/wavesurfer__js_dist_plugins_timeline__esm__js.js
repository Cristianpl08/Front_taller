  ...
  for (const [t3, s2] of Object.entries(e2))
    if ("children" === t3 && s2)
      for (const [t4, e3] of Object.entries(s2))
        e3 instanceof Node ? n2.appendChild(e3) : "string" == typeof e3 ? n2.appendChild(document.createTextNode(e3)) : n2.appendChild(i(t4, e3));
    else
      "style" === t3 ? Object.assign(n2.style, s2) : "textContent" === t3 ? n2.textContent = s2 : n2.setAttribute(t3, s2.toString());
  return n2;
}
function n(t2, e2, n2) {
  return i(t2, e2 || {});
